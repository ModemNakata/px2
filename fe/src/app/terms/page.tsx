      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="space-y-6">
          ...
          <p className="leading-relaxed text-gray-300">
            Welcome to Glosy. These Terms of Service govern your use of our platform. By accessing or using
            Glosy, you agree to be bound by these terms.
          </p>

          <div className="space-y-4">
            <h2 className="text-2xl font-semibold">1. Acceptance of Terms</h2>
            <p className="text-gray-400">
              By using Glosy, you accept these Terms of Service and Privacy Policy. If you do not agree to these
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400">
              You retain all rights to content you upload to Glosy. By uploading content, you grant Glosy a
              worldwide, royalty-free license to use, display, and distribute your content for the purpose of
              operating the platform. Glosy does not claim ownership of your content.
            </p>
          </div>
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400">
              Glosy charges a 5% platform fee on all transactions. Payments are processed through third-party
              cryptocurrency processors. You are responsible for understanding the terms and conditions of the
              payment processor. Glosy is not responsible for payment processor errors or failures. All fees are
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400">
              Glosy reserves the right to terminate or suspend your account at any time, with or without cause,
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400">
              Glosy is provided on an "as-is" basis. We disclaim all warranties, express or implied, including
              any warranty of merchantability, fitness for a particular purpose, or non-infringement. Glosy
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400">
              You agree to indemnify, defend, and hold harmless Glosy and its operators from any claims,
          ...
          <div className="space-y-4">
            ...
            <p className="text-gray-400">
              Glosy reserves the right to modify these Terms of Service at any time. Continued use of the
